...
public class ManagerSystemConfigController {
    ...
    public ResponseEntity<ApiResponse<List<SystemConfigResponse>>> getAllConfigs() {
        ...
        return ResponseEntity.ok(ApiResponse.success(list, "Lấy danh sách cấu hình cửa hàng thành công"));
    }
    ...
    public ResponseEntity<ApiResponse<SystemConfigResponse>> updateConfig(
        ...
        return ResponseEntity.ok(ApiResponse.success(response, "Cập nhật cấu hình thành công"));
    }
}
