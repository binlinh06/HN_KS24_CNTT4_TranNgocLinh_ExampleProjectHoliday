...
export default function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  if (checking || !user || !user.roles.includes('MANAGER')) {
    return (
  ...
  const links = [{"title":"Dashboard","href":"/manager"},{"title":"Duyệt đánh giá khách","href":"/manager/reviews"},{"title":"Ca làm việc & Chấm công","href":"/manager/shifts"},{"title":"Chấm công chi tiết","href":"/manager/attendance"},{"title":"Kho nguyên liệu","href":"/manager/inventory"},{"title":"Báo cáo doanh số","href":"/manager/reports"}];
      ...
      <aside className="w-64 bg-stone-900 text-stone-300 flex flex-col border-r border-stone-800 shrink-0">
        <div className="h-16 px-6 border-b border-stone-800 flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-[9px] text-pho-400 font-bold uppercase tracking-widest block -mt-1">Manager Portal</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b border-stone-200 px-8 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2 text-xs text-stone-500 font-medium">
            ...
            <span className="text-stone-800 font-semibold">Manager</span>
          </div>
