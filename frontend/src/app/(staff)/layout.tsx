...
export default function StaffLayout({ children }: { children: React.ReactNode }) {
  ...
  if (checking || !user || !user.roles.includes('STAFF')) {
    return (
  ...
  const links = [{"title":"Dashboard","href":"/staff"},{"title":"Tiếp nhận đơn online","href":"/staff/orders"},{"title":"Sơ đồ bàn ăn","href":"/staff/tables"},{"title":"Bán hàng POS tại quầy","href":"/staff/pos"},{"title":"Màn hình nhà bếp","href":"/staff/kitchen"}];
      ...
      <aside className="w-64 bg-stone-900 text-stone-300 flex flex-col border-r border-stone-800 shrink-0">
        <div className="h-16 px-6 border-b border-stone-800 flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="text-[9px] text-pho-400 font-bold uppercase tracking-widest block -mt-1">Staff Portal</span>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b border-stone-200 px-8 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2 text-xs text-stone-500 font-medium">
            ...
            <span className="text-stone-800 font-semibold">Staff</span>
          </div>
